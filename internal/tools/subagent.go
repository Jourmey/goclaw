...
// Spawn stub - subagent spawning removed
func (sm *SubagentManager) Spawn(ctx context.Context, parentID string, depth int, message, label, model, channel, chatID, peerKind string, callback AsyncCallback) (string, error) {
	return "", nil
}
